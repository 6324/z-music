<template xmlns:image="http://www.w3.org/1999/html">
  <flexbox :gutter="0" :orient="'vertical'">
    <flexbox-item>
      <div class="foo" :style="{backgroundImage: 'url(' + personalizedInfo.coverImgUrl + ')'}">
      </div>
      <div class="bar">
        <div>
          ...
          <flexbox :gutter="0">
            <flexbox-item>
              <personalized class="personalized-img" :imgw="'130px'" :imgh="'130px'"
                            ...
                            :playCount="personalizedInfo.playCount"></personalized>
            </flexbox-item>
            <flexbox-item :style="{height:'130px',color:'white',marginLeft:'-20px'}">
    ...
    <flexbox-item style="  background-color: #fff">
      <flexbox style="height: 50px" :gutter="0" :align="'center'">
        ...
        <flexbox-item :span="8">
          ...
          <span style="font-size: 10px;color: #aaaaaa">共(20)首</span>
        </flexbox-item>
    ...
    <flexbox-item style="background-color: #fff">
      <base-song-menu v-for="(items,index) in personalizedInfo.tracks"
                      :name="items.name"
                      :alia="items.alia[0]"
                      :ar="items.ar[0].name"
                      :al="items.al.name"
